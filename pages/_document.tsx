    ...
    return (
      <Html lang='en'>
        ...
        <Head>
          ...
          <meta property='og:url' content='https://anksjain.com/icon.png' />
          ...
          />
          <meta property='og:image' content='https://anksjain.com/icon.png' />
          ...
          <meta
            ...
            content='A Backend developer from Gurugram,helping businesses to grow and solving problems by providing a efficient & scalable backend service'
          />
          <meta name='twitter:image' content='https://anksjain.com/icon.png' />
